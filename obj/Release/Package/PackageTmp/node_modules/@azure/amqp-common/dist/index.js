...
class AadTokenProvider {
    constructor(credentials) {
        ...
        if (!credentials ||
            (credentials &&
                !(credentials instanceof msRestNodeauth.ApplicationTokenCredentials ||
                    credentials instanceof msRestNodeauth.UserTokenCredentials ||
                    credentials instanceof msRestNodeauth.DeviceTokenCredentials ||
                    credentials instanceof msRestNodeauth.MSITokenCredentials))) {
        ...
        if (credentials instanceof msRestNodeauth.MSITokenCredentials) {
            credentials.resource = aadEventHubsAudience;
        }
